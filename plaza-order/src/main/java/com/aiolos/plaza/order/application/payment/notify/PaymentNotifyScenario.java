...
public enum PaymentNotifyScenario {
    ...
    ALREADY_IN_REFUND_FLOW {
        @Override
        public String handle(PaymentResultContext context, PaymentNotifyOrchestrator support) {
    ...
    public abstract String handle(PaymentResultContext context, PaymentNotifyOrchestrator support);
}
