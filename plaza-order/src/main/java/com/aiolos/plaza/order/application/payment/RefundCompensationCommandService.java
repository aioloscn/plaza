 ...
 */
@Service
public class RefundCompensationCommandService {
    ...
    public RefundCompensationCommandService(ParentOrderMapper parentOrderMapper,
    ...
    private PaymentCompensationTask prepareRefundCompensationTask(String parentOrderSn,
        ...
        String refundRequestNo = taskFactory.buildRefundRequestNo(parentOrderSn);
        ...
        if (refundOrder == null) {
            refundOrder = taskFactory.buildRefundOrder(parentOrder, refundRequestNo, reasonCode);
