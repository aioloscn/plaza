...
public class CachedProductSnapshotReader implements ProductSnapshotReader {
    ...
    @Resource
    private ProductSnapshotCacheSupport productSnapshotCacheSupport;
    ...
    public Map<Long, InventoryProductSnapshot> loadSnapshots(List<Long> productIds) {
        ...
        for (Long productId : productIds) {
            ...
            InventoryProductSnapshot cachedSnapshot = productSnapshotCacheSupport.readSnapshot(productId);
        ...
        if (!missIds.isEmpty()) {
            ...
            dbSnapshots.forEach((productId, snapshot) -> {
                ...
                productSnapshotCacheSupport.writeSnapshot(snapshot);
            });
        }
        return snapshots;
    }
